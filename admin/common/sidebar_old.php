  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php  if($page == 'products' || $page == 'products_add' || $page == 'stock_product') { echo 'active menu-open'; } ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if($page == 'stock_product'){ echo "active"; } ?>"><a href="stock_product.php"><i class="fa fa-circle-o"></i>Stock</a></li>
        ...
        <li class="treeview <?php if($page == 'drivers' || $page == 'drivers_add' || $page == 'users' || $page == 'users_add' || $page == 'suppliers' || $page == 'suppliers_add' || $page == 'customers' || $page == 'customers_add') { echo 'active menu-open'; } ?>">
          ...
          <ul class="treeview-menu">
            <li class="users"></li>
             <li class="<?php if($page == 'users'){ echo "active"; } ?>"><a href="users.php"><i class="fa fa-circle-o"></i> List Users</a></li>
            <li class="<?php if($page == 'users_add'){ echo "active"; } ?>"><a href="users_add.php"><i class="fa fa-circle-o"></i> Add User</a></li>
        ...
        <li class="treeview <?php if($page == 'reports_settle_sales' || $page == 'reports_tax' || $page == 'reports_item_wise' || $page == 'wastage_expired_ingredient' || $page == 'top_ratings' || $page == 'poor_ratings' || $page == 'top_selling_product' || $page == 'reports_driver' ||  $page == 'reports_current_item_wise' ||  $page == 'reports_category_wise' ||  $page == 'reports_current_category_wise'){ echo 'active menu-open'; } ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if($page == 'reports_driver'){ echo "active"; } ?>"><a href="reports_driver_wise.php"><i class="fa fa-circle-o"></i>Driver Wise Report</a></li>
             <li class="<?php if($page == 'reports_current_item_wise'){ echo "active"; } ?>">
              <a href="reports_current_item_wise.php"><i class="fa fa-circle-o"></i>Ongoing Item Wise Report</a>
            </li>
            
            <li class="<?php if($page == 'reports_category_wise'){ echo "active"; } ?>">
              <a href="reports_category_wise.php"><i class="fa fa-circle-o"></i>Category Wise Report</a>
            </li>
            <li class="<?php if($page == 'reports_current_category_wise'){ echo "active"; } ?>">
              <a href="reports_current_category_wise.php"><i class="fa fa-circle-o"></i>Ongoing Category Wise Report</a>
            </li>
