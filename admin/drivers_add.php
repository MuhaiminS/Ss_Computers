		   ...
		   <input type="hidden" name="manufacturing_unit_id" id="manufacturing_unit_id" value="1" />
            <div class="col-md-6">		
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Enter ..." name="name" id="name" value="<?php echo safeTextOut(htmlspecialchars($name)); ?>"/>
				</div>					
				 <div class="form-group">
			    <label>Email</label>
			    <input type="text" class="form-control" placeholder="Enter ..." name="email" id="email" value="<?php echo safeTextOut(htmlspecialchars($email)); ?>"/>
				  ...
				  <div class="form-group">
			    <label>Phone</label>
			    <input type="text" class="form-control" placeholder="Enter ..." name="phone" id="phone" value="<?php echo safeTextOut(htmlspecialchars($phone)); ?>"/>
			  </div>
			    <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control datepicker" placeholder="Enter ..." name="doj" id="doj" value="<?php echo safeTextOut(htmlspecialchars($doj)); ?>"/>
				</div>
				<!-- /.form-group -->
				<div class="form-group">
					<?php 
            ...
            <div class="col-md-6">
				<div class="form-group">
             	 ...
             	 <div class="form-group">
						...
						<div class="row">
							<div class="col-sm-12">
								<p><small>Passport Image</small></p>
								<div>
					...
					<div class="form-group">
						<label class="control-label" for="form-styles">ID Proof</label>
						<div class="row">
							<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<p><small>ID Proof Image</small></p>
								<div>
             	 ...
             	 <div class="form-group">
						<label class="control-label" for="form-styles">Photo</label>
						<div class="row">
							<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<p><small>Photo Image</small></p>
								<div>
									<img src="<?php echo $image_img_dir.$image; ?>" width="100" height="80" alt="<?php echo $image; ?>" />
								</div>
							</div>
						</div>
						<?php } ?>
