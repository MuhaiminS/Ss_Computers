												...
												<td>
													<div class="text-center">
														<div class="btn-group">
															...
															<a href="javascript:void(0)" data-toggle="modal" data-target="#delete<?php echo $prow->id; ?>" title="Delete Category" class="tip btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
														</div>
													</div>
												</td>
											</tr> 
