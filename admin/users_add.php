...
if(isset($_POST['user_post'])) {
	...
	if(isset($_POST['user_id']) && $_POST['user_id'] > 0) {
		...
		$qry = "UPDATE users SET user_name = '".safeTextIn($user_name)."', role_id = '$role_id', user_action = '$action_id',manufacturing_unit_id = '$manufacturing_unit_id', shop_id = '$shop_id', first_name = '".safeTextIn($first_name)."', last_name = '".safeTextIn($last_name)."', email = '".safeTextIn($email)."', phone = '$phone', is_active = '$is_active' WHERE id = '$user_id'";
		...
		$qry = "INSERT INTO users (user_name, user_pass, role_id,  	manufacturing_unit_id, user_action, shop_id, first_name, last_name, email, phone, is_active) VALUES ('".safeTextIn($user_name)."', '".md5(safeTextIn($user_pass))."', '$role_id', '$manufacturing_unit_id', '$action_id', '$shop_id', '".safeTextIn($first_name)."', '".safeTextIn($last_name)."', '".safeTextIn($email)."', '$phone', '$is_active')";
		//echo $qry;
		if(mysqli_query($GLOBALS['conn'], $qry)){		
			$user_id = mysqli_insert_id($GLOBALS['conn']);
		}
	}
	redirect('users.php?resp=addsucc');
}
...
{
	$roles_arr = array();
	$query = "SELECT * FROM users_role WHERE id != '1' ORDER BY id ASC";
									...
									<fieldset>
										...
										<label class="col-sm-3 control-label">Actions</label>
											<div class="col-sm-4">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="crm" <?php if (in_array('crm',$action_id)){ echo "checked"; }?>> CRM
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="counter_sale" <?php if (in_array('counter_sale',$action_id)){ echo "checked"; }?>> Counter sale
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="delivery_sale" <?php if (in_array('delivery_sale',$action_id)){ echo "checked"; }?>> Delivery sale
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>	
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="dine_in" <?php if (in_array('dine_in',$action_id)){ echo "checked"; }?>> Dine in
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="take_away" <?php if (in_array('take_away',$action_id)){ echo "checked"; }?>> Take away
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="reports" <?php if (in_array('reports',$action_id)){ echo "checked"; }?>> Reports
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="expense" <?php if (in_array('expense',$action_id)){ echo "checked"; }?>> Expenses
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="credit_sale" <?php if (in_array('credit_sale',$action_id)){ echo "checked"; }?>> Credit Sales
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="settle_sale" <?php if (in_array('settle_sale',$action_id)){ echo "checked"; }?>> Settle sale
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="cod_log" <?php if (in_array('cod_log',$action_id)){ echo "checked"; }?>> Cod log
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
													</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="reviews" <?php if (in_array('reviews',$action_id)){ echo "checked"; }?>> Reviews
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="sale_order_details" <?php if (in_array('sale_order_details',$action_id)){ echo "checked"; }?>> Sale order details
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
												<!-- <div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="cash_back" <?php if (in_array('cash_back',$action_id)){ echo "checked"; }?>> Cash back
													  <i class="fa fa-square-o"></i>
													 </label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="barcode_print" <?php if (in_array('barcode_print',$action_id)){ echo "checked"; }?>> Barcode print
													  <i class="fa fa-square-o"></i>
													 </label>
												</div>	 -->											
											</div>
										...
										<label class="col-sm-3 control-label">Actions</label>
											<div class="col-sm-4">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="crm"> CRM
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="counter_sale"> Walk In
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="delivery_sale"> Delivery sale
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>	
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="dine_in"> Dine in
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="take_away"> Take away
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="reports"> Reports
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="expense"> Expenses
													 <!--  <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="credit_sale"> Credit Sales
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="settle_sale"> Settle sale
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="cod_log"> Cod log
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
													</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="action_id[]" value="reviews"> Reviews
														<!-- <i class="fa fa-square-o"></i> -->
													</label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="sale_order_details"> Sale order details
													  <!-- <i class="fa fa-square-o"></i> -->
													 </label>
												</div>
												<!-- <div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="cash_back"> Cash back
													  <i class="fa fa-square-o"></i>
													 </label>
												</div>
												<div class="checkbox">
													 <label>
													  <input type="checkbox" name="action_id[]" value="barcode_print"> Barcode print
													  <i class="fa fa-square-o"></i>
													 </label>
												</div> -->												
											</div>
