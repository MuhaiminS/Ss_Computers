                  ...
                  <input type="hidden" name="id" value="<?php echo $id; ?>" />
                    ...
                    <div class="form-group box-content2">
                      <label class=" control-label">VAT %</label>
                        ...
                        <input type="text" name="supplier_vat" id="supplier_vat" value="5" class="form-control number"  required value="<?php echo $supplier_vat; ?>"  />
                      </div>
                    ...
                    <div class="form-group box-content1">
                      <label class=" control-label">Sub Total</label>
                        ...
                        <input type="text" name="sub_total" id="sub_total" class="form-control number" required value="<?php echo $sub_total; ?>" />
                      </div>
