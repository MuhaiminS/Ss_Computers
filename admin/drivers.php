							...
							for($p = 0; $p < $pcount; $p++) {
								...
								echo "<td>";									
									echo '<div class="text-center">';
										...
										echo '<a href="drivers_add.php?id='.$id.'&act=edit" title="Edit staff" class="tip btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>';
										...
										echo '<a href="javascript:void(0)" onclick="deleteIt('.$id.');" title="Delete staff" class="tip btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>';
										echo "</div>";
										echo "</div>";
									echo "</td>";
									echo "</tr>";
